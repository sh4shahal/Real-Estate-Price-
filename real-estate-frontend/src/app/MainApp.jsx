...
export default function MainApp() {
  ...
  return (
    // ✅ Wrap entire app in PredictionProvider so all children share prediction state
    <PredictionProvider>
            ...
            >
              ...
              <div className="space-y-8">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Smart property search, real-time insights, and seamless experiences — all in one place.
                </p>

                <div className="grid grid-cols-2 gap-6">
                  {[
                    { name: "Smart Search", desc: "Find homes that match your lifestyle" },
                    { name: "Market Insights", desc: "Real-time data to make smarter decisions" },
                    { name: "Schedule Tours", desc: "Book visits and connect with agents" },
                    { name: "Trusted & Secure", desc: "Verified listings and secure transactions" },
                  ].map((item, i) => (
                    <motion.div
                      key={item.name}
                      initial={{ opacity: 0, y: 20 }}
